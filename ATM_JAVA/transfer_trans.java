...
//	JLabel lbltransferTo = new JLabel("Transfer to");
	...
	public transfer_trans() throws ClassNotFoundException{
	...
	//	pane.add(lbltransferTo);
 	...
 	//	lbltransferTo.setBounds(200,10,140,20);
		...
		btnRegister2.setToolTipText("Click To display your balance");
		...
		try{
			...
			cn = DriverManager.getConnection("jdbc:ucanaccess://E:/ATM/project.mdb");
